...
import ChildGridMinimal from "./ChildGridMinimal";
...
const ChildCourseMinimal: React.FC<Props> = ({
    groupCourse,
    day,
    className,
}) => {
    const [IsExpand, setIsEetexpand] = useState<boolean>(true);
...
export default ChildCourseMinimal;
